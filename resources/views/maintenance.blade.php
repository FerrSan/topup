...
<body class="bg-dark-bg text-gray-100 min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        <div class="inline-flex items-center justify-center w-24 h-24 bg-zinc-900/60 rounded-full mb-8">
